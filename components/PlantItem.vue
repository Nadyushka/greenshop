...
const addRemoverProductToCart = async () => {
  if (addedToCart.value) {
    ...
    await plantsStore.removeProductFromCart(id.value)
...
<template>
  <div class="plant" :class="{ 'plant_selected': isTouched}">
      ...
      <div class="plant__actions" :class="{'plant__actions_visible': isTouched}">
        ...
        >
          <svg width="20"
               ...
               :class="{'plant__cart_selected': addedToCart}"
          >
            <path
        ...
        >
          <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              :class="{'plant__selected_saved': saved}"
          >
            <path
    ...
    <div class="plant__price">
      <div class="plant__discounted"> ${{ currentPrice }}.00</div>
      <div class="plant__regular" v-if="discount">${{ price }}.00</div>
    </div>
  </div>
</template>
...
.plant__cart_selected path,
.plant__selected_saved path {
  fill: #46A358;
}

.plant__watch:active path {
  fill: #46A358;
